...
public class agendaControllerDatos {
    
    public ArrayList<DisponibilidadCita> getDisponibilidadDatos(int cod_cliente, int cod_doctor, String fecha) throws SQLException{
        
        ConexionDB cone = new ConexionDB();
        
        Connection con = cone.obtener();
        DisponibilidadCita cita = new DisponibilidadCita();
        ArrayList<DisponibilidadCita> ACita = new ArrayList<DisponibilidadCita>();
    ...
    public ArrayList CRUDcita(int accion, Cita cita) throws SQLException{
