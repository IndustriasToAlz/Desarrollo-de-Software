...
public class doctorControllerDatos {
    
    public ArrayList<Doctor> getDoctorDatos(String rut) throws SQLException{
        
        ConexionDB cone = new ConexionDB();
        
        Connection con = cone.obtener();
        Doctor doctor = new Doctor();
        ArrayList<Doctor> ADoctor = new ArrayList<Doctor>();
    ...
    public ArrayList<Doctor> getDoctoresListaDatos() throws SQLException{
    ...
    public ArrayList CRUDoctor(int accion,Doctor doctor) throws SQLException{
