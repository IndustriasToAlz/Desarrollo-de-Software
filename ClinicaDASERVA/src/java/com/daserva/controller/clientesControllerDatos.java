...
public class clientesControllerDatos {
    
    public ArrayList<Cliente> getClienteDatos(String rut) throws SQLException{
    ...
    public ArrayList CRUCliente(int accion,Cliente cliente) throws SQLException{
