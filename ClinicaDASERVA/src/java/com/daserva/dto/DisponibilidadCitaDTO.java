...
public class DisponibilidadCitaDTO implements Serializable {
    ...
    public DisponibilidadCitaDTO(Long id, String hora, int codigoCliente, int codigoDoctor, int asignada) {
        this.hora = hora;
